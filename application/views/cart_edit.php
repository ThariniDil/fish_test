...
<div class="row">
 <div class="col-md-8 col-md-offset-2">
		<h2 class="text-center">Edit Cart form here </h2>
		<br><br>
	<?php
      ...
      foreach ($edit_data as $key => $data) { 
          //var_dump($data);
    ?>
	<form method="post" action="<?php echo site_url('Cart/update_data/'.$data['id'].''); ?>" name="data_register">
		<label for="Quantity">Enter Cart Quantity Here</label>
		<input type="text" class="form-control" name="qy" value="<?php echo $data['quantity']; ?>" required >
		<br>
